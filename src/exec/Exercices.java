...
//  Exercices.exercice30();
   ...
   public static void exercice6() {
    ...
    public static void exercice23() {
        System.out.println("*************************************");
        System.out.println(" Methode qui affiche le nombre d’occurrence des caractères : ");
        String str = Clavier.lireString();
    ...
    public static void exercice27(){
    	System.out.println("*************************************");
    	System.out.println("une méthode qui demande la saisie d'un string composé de 1 et 0");
    	String nbr1 = Clavier.lireString();
    	int str = Calculatrice.binaire(nbr1);
    	System.out.println("le nomber est : "+str);
    }
    
    public static void exercice30() {
    	System.out.println("*************************************");
    	System.out.println("une méthode qui demande la saisie un double et le calcule ");
    	String nbr1 = Clavier.lireString();
    	String str = Calculatrice.exercice30(nbr1);
    	System.out.println("le nombre  : "+str);
    }
    
    public static void exercice31() {
    	System.out.println("**************************************");
    	System.out.println("créer un programme Exercice31 qui demande la saisie d'un string");
    	String a = Clavier.lireString();
    	String b = Calculatrice.exercice31(a);
